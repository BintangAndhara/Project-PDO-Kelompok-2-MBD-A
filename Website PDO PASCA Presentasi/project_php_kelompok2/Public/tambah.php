                            ...
                            <div class="row g-4 mb-5">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="harga_reguler" class="form-control" required step="0.01" placeholder="15000">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text fw-medium text-secondary">Rp</span>
                                        <input type="number" name="harga_large" class="form-control" required step="0.01" placeholder="18000">
                                    </div>
                                    <div class="form-text small text-secondary">*Bisa pakai titik/koma (cth: 19500.50)</div>
                                </div>
                            </div>
