...
<body>
                    ...
                    <table class="table table-hover align-middle mb-0">
                        <thead>
                            <tr>
                                ...
                                <th width="20%">Harga Reguler</th>
                                <th width="20%">Harga Large</th>
                        ...
                        <tbody>
                            <?php if (count($data) > 0): ?>
                                ...
                                <tr>
                                    ...
                                    <td class="fw-semibold text-secondary">Rp <?= number_format($row['Harga_Reguler'], 2, ',', '.'); ?></td>
                                    <td class="fw-semibold" style="color: #07779D;">Rp <?= number_format($row['Harga_Large'], 2, ',', '.'); ?></td>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="6" class="text-center py-5 text-muted">Belum ada menu yang aktif.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
    ...
    <footer class="footer-custom">
        <div class="container">
            <p class="mb-1 fw-medium" style="color: #1E293B;">Mini Project IV - Sistem Point of Sale (PoS)</p>
    ...
    <script>
       function konfirmasiHapus(id, namaMenu) {
            Swal.fire({
                title: '<span style="color:#003F63">Hapus Permanen?</span>',
                html: `Apakah kamu yakin ingin menghapus <b>${namaMenu}</b> secara permanen dari MySQL?<br><span style="color:#EF4444; font-size:14px; font-weight:500;">(Perhatian: Hanya bisa dihapus jika menu belum pernah dipesan).</span>`,
                icon: 'warning',
