...
<head>
    ...
    <title>Edit Menu - Lokale Select</title>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-9 col-xl-8">
                <div class="card card-custom">
                    <div class="card-header bg-white border-0 pt-5 pb-3 px-5 d-flex justify-content-between align-items-center">
                        <div class="d-flex align-items-center gap-4">
                            ...
                            <div>
                                <h4 class="fw-bold mb-1" style="color: #003F63;">Edit Informasi Menu</h4>
                                <p class="text-secondary small mb-0">Sesuaikan data produk yang baru.</p>
                            </div>
                        </div>
                        <span class="badge rounded-pill fs-6 px-3 py-2 border" style="background-color: #F8FAFC; color: #005B8F; border-color: #CBD5E1 !important;"><?= htmlspecialchars($menu['Id_Menu']); ?></span>
                    </div>
                        ...
                        <form action="../process/update.php" method="POST">
                            ...
                            <div class="row g-4 mb-4">
                                <div class="col-md-7">
                                    ...
                                    <input type="text" name="nama_menu" class="form-control" value="<?= htmlspecialchars($menu['Nama_Menu']); ?>" required maxlength="100">
                                </div>
                                <div class="col-md-5">
                                    <label class="form-label">Kategori</label>
                                    <select name="kategori" class="form-select" required>
                                        <option value="Coffee" <?= ($menu['Kategori'] == 'Coffee') ? 'selected' : ''; ?>>Coffee</option>
                                        <option value="Main Dish" <?= ($menu['Kategori'] == 'Main Dish') ? 'selected' : ''; ?>>Main Dish</option>
                            ...
                            <div class="row g-4 mb-5">
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="harga_reguler" class="form-control" value="<?= htmlspecialchars($menu['Harga_Reguler']); ?>" required step="0.01">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Harga Large</label>
                                    <div class="input-group">
                                        <span class="input-group-text fw-medium text-secondary">Rp</span>
                                        <input type="number" name="harga_large" class="form-control" value="<?= htmlspecialchars($menu['Harga_Large']); ?>" required step="0.01">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="d-flex justify-content-end gap-3 mt-3 pt-4 border-top">
                                ...
                                <button type="submit" class="btn btn-custom"><i class="bi bi-check2-circle me-2"></i>Simpan Perubahan</button>
                            </div>
                        </form>
                    </div>
                </div>
