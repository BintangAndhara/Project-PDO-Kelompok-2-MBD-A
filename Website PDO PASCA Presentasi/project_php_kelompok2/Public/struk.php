...
// Query Detail Transaksi di-update, nggak butuh JOIN ke Menu lagi
    ...
    <div class="receipt-wrapper">
        ...
        <table class="item-table">
            ...
            <tbody>
                ...
                <tr>
                    <td class="item-name">
                        <?= htmlspecialchars($d['Nama_Menu_Snapshot']) ?> <br>
                        <small style="color: #555;">(<?= htmlspecialchars($d['Ukuran']) ?>)</small>
                    </td>
                    <td class="text-center"><?= $d['Jumlah_Beli'] ?>x</td>
                    <td class="text-right"><?= number_format($d['Total_Harga_Item'], 2, ',', '.') ?></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
        ...
        <table class="total-table">
            <tr>
                <td>Subtotal</td>
                <td class="text-right"><?= number_format($transaksi['Total_Harga'], 2, ',', '.') ?></td>
            </tr>
            <tr>
                <td>Tax (10%)</td>
                <td class="text-right"><?= number_format($transaksi['Nilai_Pajak'], 2, ',', '.') ?></td>
            </tr>
            <tr class="grand-total">
                <td>TOTAL</td>
                <td class="text-right">Rp <?= number_format($transaksi['Total_Akhir'], 2, ',', '.') ?></td>
            </tr>
        </table>
