...
CREATE TABLE Menu (
    ...
    Harga_Large DECIMAL(12,2) NOT NULL,
...
CREATE TABLE Detail_Transaksi (
    ...
    Nama_Menu_Snapshot VARCHAR(100) NOT NULL,
    Ukuran VARCHAR(20) NOT NULL,
    Harga_Snapshot DECIMAL(12,2) NOT NULL,
    Jumlah_Beli INT NOT NULL,
    Total_Harga_Item DECIMAL(12,2) NOT NULL,
...
INSERT INTO Menu (Id_Menu, Kategori, Nama_Menu, Harga_Reguler, Harga_Large) VALUES
('MN001', 'Coffee', 'Kopi Susu Lokale', 19000, 23000),
('MN002', 'Coffee', 'Kopi Susu Raya', 24000, 28000),
('MN003', 'Coffee', 'Americano', 20000, 24000),
('MN004', 'Coffee', 'Aren Latte', 25000, 29000),
('MN005', 'Coffee', 'Hazelnut Latte', 28000, 32000),
('MN006', 'Coffee', 'Butterscotch Latte', 28000, 32000),
('MN007', 'Coffee', 'Oat Latte', 31000, 35000),
('MN008', 'Main Dish', 'Teriyaki Beef', 38000, 43000),
('MN009', 'Main Dish', 'Mie Kuah Lokale', 22000, 27000),
('MN010', 'Main Dish', 'Smoked Beef Carbonara', 38000, 43000),
('MN011', 'Main Dish', 'Nasi Telor Pontianak', 22000, 27000),
('MN012', 'Main Dish', 'Nasi Goreng Nusantara', 27000, 32000),
('MN013', 'Main Dish', 'Soto Betawi', 45000, 50000),
('MN014', 'Main Dish', 'Salted Egg Chicken', 35000, 40000),
('MN015', 'Dessert', 'Milkbun', 32000, 35000),
('MN016', 'Dessert', 'Nuttela Delight', 19000, 22000),
('MN017', 'Dessert', 'Banana Raisin Cake', 27000, 30000),
('MN018', 'Dessert', 'Buttermilk Croissant', 33000, 36000),
('MN019', 'Dessert', 'Cinnamon Roll', 33000, 36000),
('MN020', 'Dessert', 'Matcha Mousse', 19000, 22000),
('MN021', 'Dessert', 'Lotus Biscoff', 19000, 22000);
...
INSERT INTO Detail_Transaksi (Id_Detail, Id_Transaksi, Id_Menu, Nama_Menu_Snapshot, Ukuran, Harga_Snapshot, Jumlah_Beli, Total_Harga_Item) VALUES
('DT001', 'TR001', 'MN004', 'Aren Latte', 'Reguler', 25000, 2, 50000),   
('DT002', 'TR002', 'MN013', 'Soto Betawi', 'Reguler', 45000, 2, 90000),   
('DT003', 'TR003', 'MN008', 'Teriyaki Beef', 'Reguler', 38000, 1, 38000),  
('DT004', 'TR004', 'MN010', 'Smoked Beef Carbonara', 'Reguler', 38000, 3, 114000), 
('DT005', 'TR005', 'MN003', 'Americano', 'Reguler', 20000, 2, 40000),  
('DT006', 'TR006', 'MN008', 'Teriyaki Beef', 'Reguler', 38000, 2, 76000),   
('DT007', 'TR007', 'MN002', 'Kopi Susu Raya', 'Reguler', 24000, 1, 24000),   
('DT008', 'TR008', 'MN014', 'Salted Egg Chicken', 'Reguler', 35000, 2, 70000),  
('DT009', 'TR009', 'MN012', 'Nasi Goreng Nusantara', 'Reguler', 27000, 4, 108000),  
('DT010', 'TR010', 'MN015', 'Milkbun', 'Reguler', 32000, 5, 160000);